...
pageEncoding="UTF-8"%> <%@ page import="bbs.BbsDAO" %> <%@ page
...
<html>
  ...
  <body>
    ...
    userID = (String) session.getAttribute("userID"); } if (userID == null) {
    ...
    "); } else { BbsDAO bbsDAO = new BbsDAO(); int result =
    bbsDAO.write(bbs.getBbsTitle(), userID, bbs.getBbsContent()); if (result ==
    -1) { PrintWriter script = response.getWriter(); script.println("
    <script>
      ");
